...
class SectionExtractor:
    ...
    def extract_deposits_section(self, text: str, summary: StatementSummary) -> List[Transaction]:
    ...
    def extract_withdrawals_section(self, text: str, summary: StatementSummary) -> List[Transaction]:
    ...
    def extract_online_banking_section(self, text: str, summary: StatementSummary) -> List[Transaction]:
